...
function atualizainterface(){
   ...
   let candidato = etapa.candidatos.filter(c => c.numero == numero);
   ...
   if(candidato.length > 0) {
    ...
    descricao.innerHTML = `Nome: ${candidato.nome} <br/> Partido: ${candidato.partido} <br/> Vice-Prefeito: ${candidato.vice}`; //ver vice
...
function confirma () {
    ...
    if(votoBranco === true) {
        ...
        votos.push({
            etapa: etapas[etapaAtual].titulo,
            voto: votoNulo == false ? numero : 'nulo'
        });
    }
